...
window.__brand = { name: '멍냥계산기', emoji: '🐾', tag: '#멍냥계산기', c1: '#f4a259', c2: '#e08a3c' };
...
/* ===== OneSignal 웹푸시 (재방문 유도) — mungnyangcalc.com / appId 입력 시 자동 활성화 ===== */
window.__onesignalAppId = '371e689d-8bd1-46ab-bfd0-c937a9eb7598';
(function(){
